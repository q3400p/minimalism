...
import com.whaty.cbs.core.bean.Module;
import com.whaty.cbs.core.util.HttpUtil;
...
public class PageReturn extends AbstractResponseRetrun {
    ...
    public String returnData(boolean success, String message, Object data) {
        ...
        baseControler.getParamenter().setValue(RESULT_SUCCESS_KEY, success);
        if (data != null) {
            baseControler.getParamenter().setValue(RESULT_DATA_KEY, data);
        }
        if (StringUtil.isNotEmpty(message)) {
            baseControler.getParamenter().setValue(RESULT_MESSAGE_KEY, message);
        }
